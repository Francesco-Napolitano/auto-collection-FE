    ...
    <nav className="w-full bg-white border-gray-200 dark:bg-gray-900 fixed top-0 z-10 overflow-y-hidden mb-2">
      <div className=" max-w-screen-xl flex flex-wrap items-center justify-center max-[464px]:pb-8 min-[464px]:justify-between mx-auto px-2">
        ...
        <div className="flex md:order-2 ">
          ...
          {token ? (
            <Link to="/logout">
              <button className="group flex items-center justify-start w-11 h-11 !bg-[#22881b] rounded-full cursor-pointer relative overflow-hidden transition-all duration-200 shadow-lg  hover:w-32 hover:rounded-lg active:translate-x-1 active:translate-y-1">
                ...
                <div className="absolute right-5 transform translate-x-full !hover:text-gray-200 opacity-0 text-gray-200 text-lg font-semibold transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
                  Logout
                </div>
              </button>
            </Link>
            ...
            <button
              type="button"
              className="text-[#22881b] bg-blue-700 ring-2 hover:bg-blue-800 font-medium rounded-lg text-sm px-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700  ml-3"
            >
              <Link to="/login">Login</Link>
            </button>
          )}
        </div>
        <ul className="flex grow justify-center pt-3 md:pt-0 font-medium  rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
          <li>
            <span
              href="#"
