      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto ">
        ...
        <div className="flex md:order-2">
          ...
          <button
            id="theme-toggle"
            type="button"
            className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-3xl p-1 px-3 "
          >
            <svg
        ...
        >
          <div className="relative mt-3 md:hidden">
            ...
            <input
              type="text"
              id="search-navbar"
              className="stop block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white "
              placeholder="Search..."
            />
          </div>
